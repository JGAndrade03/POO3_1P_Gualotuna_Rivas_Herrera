...
public class ManejoArchivos {
    ...
    public static ArrayList<Estudiante> genListaEstudiantes(ArrayList<String> a1, ArrayList<String> a2){
        ...
        for(String user : a1){
            ...
            if(l_user.get(7).equals("E")){
                ...
                for(String est: a2){
                    ArrayList<String> l_estudiantes = new ArrayList<>();
                    String[] a_estudiante = est.split("\\|");
                    for (String elemento : a_estudiante){
                        l_estudiantes.add(elemento.strip());

                    }

                    if(l_user.get(0).equals(l_estudiantes.get(0))){
                        estudiante.setMatricula(l_estudiantes.get(4));
                        estudiante.setCarrera(l_estudiantes.get(5));
    ...
    public static ArrayList<Profesor> genListaProfesores(ArrayList<String> a1, ArrayList<String> a3){
    ...
    public static ArrayList<Administrador> genListaAdministradores(ArrayList<String> a1, ArrayList<String> a4){
